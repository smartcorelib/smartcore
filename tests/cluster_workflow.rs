...
fn kmeans_inline_workflow() {
    ...
    // Both clusters should be internally consistent
...
fn dbscan_inline_workflow() {
    ...
    // No point should be noise (label 0 in smartcore DBSCAN means noise)
    assert!(
...
fn kmeans_iris_workflow() {
    ...
    // Should produce exactly 3 distinct cluster ids
